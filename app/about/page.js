...
import paintbrush from "../../public/—Pngtree—vector drawing brush icon_4101432.png";
  ...
  return (
    <div className={styles.about}>
      ...
      <p className={styles.about_text}>
        I am a Lithuanian-American artist based out of Columbus, OH. For as long as
      ...
      <p className={styles.about_text}>
  The play between light and darkness is prevalent throughout my
