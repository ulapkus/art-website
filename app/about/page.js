...
const about = () => {
  return (
    <div className="about">
      <h2>ABOUT ME</h2>
      <p className="about-p">
        My name is Kristė Aukštuolis and I live in Ohio. Blah blah blah random text Art is a diverse range
        of human activity and its resulting product that involves creative or
        imaginative talent generally expressive of technical proficiency,
        ...
        aesthetics. The resulting artworks are studied in the professional
